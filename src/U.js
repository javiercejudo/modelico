...
const get = (field/*: string */) => (obj/*: Object */) =>
  obj[field]

const pipe2 = (f/*: Function */, g/*: Function */) => (...args/*: Array<mixed> */) =>
  g(f(...args))

const not = (x/*: boolean */)/*: boolean */ =>
  !x
...
export const always = /*:: <T> */(x/*: T */) => ()/*: T */ =>
  x

export const isNothing = (v/*: mixed */)/*: boolean */ =>
...
export const defaultTo = (d/*: mixed */) => (v/*: mixed */) =>
  isNothing(v)
    ? d
    : v
...
export const isPlainObject = (x/*: mixed */)/*: boolean */ =>
  typeof x === 'object' && !!x

export const isFunction = (x/*: mixed */)/*: boolean */ =>
  typeof x === 'function'
