;(function(global, factory) {
    ...
    return function() {
        ...
        var Country = (function(_M$Base) {
          ...
          function Country(props) {
            ...
            return possibleConstructorReturn(
              this,
              (Country.__proto__ || Object.getPrototypeOf(Country))
                .call(this, Country, props)
            )
          }
        ...
        it('allows simple model creation without inner types (discouraged)', function() {
          var Book = (function(_M$createModel) {
            ...
            function Book(props) {
              ...
              return possibleConstructorReturn(
                this,
                (Book.__proto__ || Object.getPrototypeOf(Book))
                  .call(this, Book, props)
              )
            }
      ...
      describe('setting', function() {
        ...
        it('should set fields returning a new object', function() {
          ...
          author2
            .equals(author1)
            .should.be.exactly(false, 'Oops, they are equal')
        })
        ...
        it('should use the metadata to coerce the value if necessary', function() {
          var CountryCallingCode = (function(_M$createModel4) {
            ...
            function CountryCallingCode(props) {
              ...
              return possibleConstructorReturn(
                this,
                (CountryCallingCode.__proto__ ||
                  Object.getPrototypeOf(CountryCallingCode))
                  .call(this, CountryCallingCode, props)
              )
            }
  ...
  var ModelicoNumber = function(U, should, M) {
    return function() {
      var _M$metadata = M.metadata(), number = _M$metadata.number
  ...
  var ModelicoDate = function(U, should, M) {
    return function() {
      var _M$metadata = M.metadata(), date = _M$metadata.date
      describe('immutability', function() {
      ...
      describe('instantiation', function() {
        it('uses the current date by default', function() {
          ...
          should(mDate.inner().getFullYear()).be.exactly(
    ...
    return function() {
      ...
      describe('setting', function() {
        ...
        it('should set fields returning a new map', function() {
          ...
          var modelicoMap2 = modelicoMap1.set(
            'a',
            M.Date.of(new Date('1989-04-16T00:00:00.000Z'))
          )
          should(
            modelicoMap2.inner().get('a').inner().getFullYear()
          ).be.exactly(1989) // verify that modelicoMap1 was not mutated
          should(
            modelicoMap1.inner().get('a').inner().getFullYear()
          ).be.exactly(1988)
        })
        ...
        it('edge case when setIn is called with an empty path', function() {
          ...
          should(map.inner().get('wedding').inner().getFullYear()).be.exactly(
            2013
          )
          ...
          should(map2.inner().get('wedding').inner().getFullYear()).be.exactly(
            2010
          )
        })
      })
      ...
      describe('parsing', function() {
        it('should parse the map correctly', function() {
          var modelicoMap = JSON.parse(
            '[["a","1988-04-16T00:00:00.000Z"],["b","2012-12-25T00:00:00.000Z"]]',
            map(string(), date()).reviver
          )
          var modelicoMapAlt = JSON.parse(
            '[["a","1988-04-16T00:00:00.000Z"],["b","2012-12-25T00:00:00.000Z"]]',
            map(
              function() {
                return string()
      ...
      describe('comparing', function() {
        it('should identify equal instances', function() {
          var modelicoMap = M.Map.fromMap(
            new Map([['a', M.Date.of(new Date('1988-04-16T00:00:00.000Z'))]])
          )
          var modelicoMap2 = M.Map.fromMap(
            new Map([['a', M.Date.of(new Date('1988-04-16T00:00:00.000Z'))]])
          )
  ...
  var ModelicoStringMap = function(should, M, _ref) {
    ...
    return function() {
      ...
      describe('setting', function() {
        it('should implement Symbol.iterator', function() {
          var map = M.StringMap.fromObject({
            a: 1,
            b: 2,
            c: 3
          })
          map.toJSON().should.eql({
            a: 1,
            b: 2,
            c: 3
          })
      ...
      describe('comparing', function() {
        it('should identify equal instances', function() {
          var modelicoMap = M.StringMap.fromMap(
            new Map([['a', M.Date.of(new Date('1988-04-16T00:00:00.000Z'))]])
          )
          var modelicoMap2 = M.StringMap.fromMap(
            new Map([['a', M.Date.of(new Date('1988-04-16T00:00:00.000Z'))]])
          )
          modelicoMap.should.not.be.exactly(modelicoMap2)
          modelicoMap.should.not.equal(modelicoMap2)
      ...
      describe('setting', function() {
        ...
        it('should set fields returning a new enum map when part of a path', function() {
          var map = new Map([
            ...
            [
              PartOfDay.EVENING(),
              M.Date.of(new Date('2012-04-16T00:00:00.000Z'))
            ]
          ])
          var greetings1 = M.EnumMap.fromMap(map)
          var greetings2 = greetings1.setIn(
            [PartOfDay.EVENING()],
        ...
        it('edge case when setIn is called with an empty path', function() {
          ...
          var map2 = new Map([
            ...
            [
              PartOfDay.EVENING(),
              M.Date.of(new Date('2013-04-16T00:00:00.000Z'))
            ]
          ])
    ...
    return function() {
      ...
      describe('setting', function() {
        ...
        it('should set items in the list correctly', function() {
          ...
          var modelicoList2 = modelicoList1.set(
            0,
            M.Date.of(new Date('1989-04-16T00:00:00.000Z'))
          )
          should(modelicoList2.get(0).inner().getFullYear()).be.exactly(1989) // verify that modelicoList1 was not mutated
        ...
        it('should set items in the list correctly when part of a path', function() {
          ...
          var modelicoList1 = M.List.fromArray(list)
          var modelicoList2 = modelicoList1.setIn(
            [0],
        ...
        it('should set items in the list correctly when part of a path with a single element', function() {
          ...
          should(modelicoList2.get(0).inner().getFullYear()).be.exactly(2000) // verify that modelicoList1 was not mutated
          should(modelicoList1.get(0).inner().getFullYear()).be.exactly(1988)
        })
        it('should be able to set a whole list', function() {
          ...
          var newListArray = [].concat(
            toConsumableArray(author1.importantDatesList())
          )
          newListArray.splice(
            1,
            0,
            M.Date.of(new Date('2016-05-03T00:00:00.000Z'))
          )
          var author2 = author1.set(
            'importantDatesList',
          ...
          should(
            [].concat(toConsumableArray(author2.importantDatesList())).length
          ).be.exactly(3)
          should(
        ...
        it('edge case when List setIn is called with an empty path', function() {
          var modelicoDatesList1 = M.List.of(
            M.Date.of(new Date('1988-04-16T00:00:00.000Z')),
            M.Date.of(new Date())
          )
          var modelicoDatesList2 = [
            M.Date.of(new Date('2016-04-16T00:00:00.000Z'))
          ]
          var listOfListOfDates1 = M.List.of(modelicoDatesList1)
          var listOfListOfDates2 = listOfListOfDates1.setIn(
            [0],
            modelicoDatesList2
          )
          should(
            listOfListOfDates1.get(0).get(0).inner().getFullYear()
          ).be.exactly(1988)
          should(
            listOfListOfDates2.get(0).get(0).inner().getFullYear()
          ).be.exactly(2016)
        })
      })
      describe('stringifying', function() {
      ...
      describe('tuples', function() {
        it('should support tuples', function() {
          M.genericsFromJS(
            ...
            .equals(
              M.List.of('a', M.Date.of(new Date('1988-04-16T00:00:00.000Z')))
            )
            .should.be.exactly(true)
        })
      ...
      describe('comparing', function() {
        ...
        it('should support non-primitive types', function() {
          var modelicoList1 = M.List.of(
            M.Date.of(new Date('1988-04-16T00:00:00.000Z'))
          )
          var modelicoList2 = M.List.of(
            M.Date.of(new Date('1988-04-16T00:00:00.000Z'))
          )
          modelicoList1.should.not.be.exactly(modelicoList2)
          modelicoList1.should.not.equal(modelicoList2)
      ...
      describe('EMPTY / of / fromArray', function() {
        it('should have a static property for the empty list', function() {
          should(
            [].concat(toConsumableArray(M.List.EMPTY())).length
          ).be.exactly(0)
    ...
    return function() {
      ...
      describe('setting', function() {
        ...
        it('edge case when Set setIn is called with an empty path', function() {
          var modelicoDatesSet1 = M.Set.of(
            M.Date.of(new Date('1988-04-16T00:00:00.000Z')),
            M.Date.of(new Date())
          )
          var modelicoDatesSet2 = new Set([
            M.Date.of(new Date('2016-04-16T00:00:00.000Z'))
          ])
          var listOfSetsOfDates1 = M.List.of(modelicoDatesSet1)
          var listOfSetsOfDates2 = listOfSetsOfDates1.setIn(
            [0],
            modelicoDatesSet2
          )
          should(
            []
              .concat(
                toConsumableArray(
                  [].concat(toConsumableArray(listOfSetsOfDates1))[0]
                )
              )[0]
              .inner()
              .getFullYear()
          ...
          should(
            []
              .concat(
                toConsumableArray(
                  [].concat(toConsumableArray(listOfSetsOfDates2))[0]
                )
              )[0]
              .inner()
              .getFullYear()
      ...
      describe('parsing', function() {
        it('should parse the set correctly', function() {
          var modelicoSet = JSON.parse(
            '["1988-04-16T00:00:00.000Z","2012-12-25T00:00:00.000Z"]',
            set$$1(date()).reviver
          )
          should(
            [].concat(toConsumableArray(modelicoSet))[0].inner().getFullYear()
          ).be.exactly(1988)
          should(
            [].concat(toConsumableArray(modelicoSet))[1].inner().getMonth()
          ).be.exactly(11)
        })
        it('should be parsed correctly when used within another class', function() {
          var authorJson =
          ...
          should(
            []
              .concat(toConsumableArray(author.importantDatesSet()))[0]
              .inner()
              .getFullYear()
          ).be.exactly(2013)
        })
      ...
      describe('comparing', function() {
        it('should identify equal instances', function() {
          var modelicoSet1 = M.Set.of(
            M.Date.of(new Date('1988-04-16T00:00:00.000Z'))
          )
          var modelicoSet2 = M.Set.of(
            M.Date.of(new Date('1988-04-16T00:00:00.000Z'))
          )
      ...
      describe('EMPTY / of / fromArray / fromSet', function() {
        ...
        it('should be able to create a set from arbitrary parameters', function() {
          ...
          ;[]
            .concat(toConsumableArray(modelicoSet))
  ...
  var ModelicoMaybe = function(U, should, M, _ref) {
    var Person = _ref.Person, PartOfDay = _ref.PartOfDay
    return function() {
      var _M$metadata = M.metadata(),
        _ = _M$metadata._,
        number = _M$metadata.number,
    ...
    return function() {
      ...
      describe('metadata', function() {
        it('should return metadata like type', function() {
          string().type.should.be.exactly(String) // using empty anyOf for testing purposes
  ...
  var setIn = function(U, should, M) {
    return function() {
      it('should work across types', function() {
        ...
        array1.setIn(
          [2, 'hammer'],
          'hm, surely I can mutate this nested object...'
        )
        array1
          .get(2)
          .inner()
    ...
    return function() {
      ...
      var Animal = (function(_M$Base) {
        ...
        function Animal(props) {
          ...
          return possibleConstructorReturn(
            this,
            (Animal.__proto__ || Object.getPrototypeOf(Animal))
              .call(this, Animal, props)
          )
        }
        createClass(
          Animal,
    ...
    return function() {
      ...
      it('should showcase the main features', function() {
        ...
        Array.from(person1.pets())
          ...
          .speak()
          .should.be.exactly('My name is Robbie!')
        var person3 = person1.setIn(
          ['pets', 0, [defaultAnimal, 'name']],
          'Bane'
        )
        person3
          .pets()
  ...
  var featuresDeepNesting = function(should, M, fixtures) {
    return function() {
      var _M$metadata = M.metadata(), _ = _M$metadata._
      it('should revive deeply nested JSON', function() {
        var Region = fixtures.Region, countryFactory = fixtures.countryFactory
        var City = fixtures.cityFactory(M, Region, countryFactory)
        var cityJson =
          '{"name":"Pamplona","country":{"name":"Spain","code":"ESP","region":{"name":"Europe","code":"EU"}}}'
      ...
      it('should support nested keys with different types', function() {
        ...
        var City = fixtures.cityFactory(M, Region, countryFactory)
        var cityJson =
          '{"name":"Pamplona","country":{"name":"Spain","code":"ESP","region":{"name":"Europe","code":{"id": 1,"value":"EU"}}}}'
        var city = JSON.parse(cityJson, _(City).reviver)
        city.name().should.be.exactly('Pamplona')
        city.country().name().should.be.exactly('Spain')
        city.country().code().should.be.exactly('ESP')
      ...
      describe('Enumerated: default type field', function() {
        ...
        var NumberCollection = (function(_M$Base) {
          ...
          function NumberCollection(props) {
            ...
            return possibleConstructorReturn(
              this,
              (NumberCollection.__proto__ ||
                Object.getPrototypeOf(NumberCollection))
                .call(this, NumberCollection, props)
            )
          }
          createClass(
            NumberCollection,
            [
              {
                ...
                value: function getNumbers() {
                  var type = this.type, collection = this.collection
                  switch (type()) {
                    ...
                    default:
                      throw TypeError(
                        'Unsupported NumberCollection with type ' +
                          type().toJSON()
                      )
                  }
                }
      ...
      describe('Based on runtime type field', function() {
        ...
        var Shape = (function(_M$createAjvModel) {
          ...
          function Shape() {
            ...
            return possibleConstructorReturn(
              this,
              (Shape.__proto__ || Object.getPrototypeOf(Shape))
            ...
            [
              {
                ...
                value: function metadata() {
                  var baseMetadata = Object.assign({}, base(Shape), {
                    reviver: reviver
                  })
        ...
        var Diamond = (function(_M$createAjvModel3) {
          ...
          function Diamond(props) {
            ...
            return possibleConstructorReturn(
              this,
              (Diamond.__proto__ || Object.getPrototypeOf(Diamond))
                .call(this, Diamond, props)
            )
          }
          createClass(Diamond, [
            {
        ...
        var Geometer = (function(_M$createAjvModel4) {
          ...
          function Geometer(props) {
            ...
            return possibleConstructorReturn(
              this,
              (Geometer.__proto__ || Object.getPrototypeOf(Geometer))
                .call(this, Geometer, props)
            )
          }
          return Geometer
        })(
            ...
            [
              {
                ...
                value: function getNumbers() {
                  ...
                  return collection[M.symbols.typeSymbol]() === M.List
                    ? [].concat(toConsumableArray(collection))
                    : [].concat(
                        toConsumableArray(
                          collection[M.symbols.innerOrigSymbol]().values()
                        )
                ...
                value: function innerTypes() {
                  return Object.freeze({
                    collection: function collection(v) {
                      return Array.isArray(v.collection)
                        ? list(number())
                        : stringMap(number())
                    }
                  })
  ...
  var ImmutableExamples = function(U, should, M) {
    return function() {
      ...
      it('JavaScript-first API', function() {
        ...
        var list4 = M.List.fromArray(
          []
            .concat(toConsumableArray(list1))
            .concat(
              [].concat(toConsumableArray(list2)),
              [].concat(toConsumableArray(list3))
            )
        )
      ...
      it('JavaScript-first API (2)', function() {
        ...
        ;[]
          .concat(toConsumableArray(alpha))
          .map(function(kv) {
      ...
      it('Accepts raw JavaScript objects.', function() {
        ...
        var map3 = M.Map.fromMap(
          new Map(
            [].concat(
              [].concat(toConsumableArray(map1)),
              [].concat(toConsumableArray(map2)),
              objToArr(obj)
            )
          )
        )
      ...
      it('Batching Mutations', function() {
        ...
        var list2 = M.List.fromArray(list2Array)
        should([].concat(toConsumableArray(list1)).length === 3).be.exactly(
          true
        )
        should([].concat(toConsumableArray(list2)).length === 6).be.exactly(
          true
        )
      })
    }
    ...
    return function() {
      ...
      it('Accepts raw JavaScript objects.', function() {
        ...
        var map3 = M.Map.fromMap(
          new Map(
            [].concat(
              [].concat(toConsumableArray(map1.entries())),
              [].concat(toConsumableArray(map2.entries())),
              objToArr(obj)
            )
          )
        )
  ...
  var proxyMap = function(should, M) {
    return function() {
      ...
      it('entries()', function() {
        ...
        ;[]
          .concat(toConsumableArray(map.entries()))
          .should.eql([['a', 1], ['b', 2], ['c', 3]])
      })
      it('values() / keys() / [@@iterator]()', function() {
        ...
        ;[]
          .concat(toConsumableArray(map[Symbol.iterator]()))
          .should.eql([['a', 1], ['b', 2], ['c', 3]])
      })
      it('forEach()', function() {
        var map = p(
    ...
    return function() {
      ...
      it('reduce() / reduceRight()', function() {
        ...
        list
          ...
          .should.be.exactly(8)
        list
          .reduce(function(str, x) {
            return str + x
          }, '')
          .should.be.exactly('1223')
        list
          .reduceRight(function(str, x) {
            return str + x
          }, '')
  ...
  var proxySet = function(should, M) {
    return function() {
      ...
      it('entries()', function() {
        var set$$1 = p(M.Set.of(1, 2, 2, 3))
        ;[]
          .concat(toConsumableArray(set$$1.entries()))
      ...
      it('values() / keys() / [@@iterator]()', function() {
        ...
        ;[]
          .concat(toConsumableArray(set$$1[Symbol.iterator]()))
          .should.eql([1, 2, 3])
      })
      it('forEach()', function() {
        var set$$1 = p(M.Set.of(1, 2, 2, 3))
  ...
  var c51 = function(should, M) {
    return function() {
      var _M$metadata = M.metadata(), string = _M$metadata.string
      var Country = (function(_M$Base) {
        inherits(Country, _M$Base)
  ...
  var personFactory = function(M, PartOfDay, Sex) {
    var joinWithSpace = function joinWithSpace() {
      for (
        var _len = arguments.length, parts = Array(_len), _key = 0;
        _key < _len;
        _key++
      ) {
        ...
        [
          {
            ...
            value: function innerTypes() {
              return Object.freeze({
                givenName: string(),
                familyName: string(),
                birthday: _(M.Date), // alternative (leaving the above for testing purposes) // birthday: date(),
  ...
  var partOfDayFactory = function(M) {
    var PartOfDay = (function(_M$Enum) {
      ...
      function PartOfDay() {
        ...
        return possibleConstructorReturn(
          this,
          (PartOfDay.__proto__ || Object.getPrototypeOf(PartOfDay))
            .apply(this, arguments)
        )
      }
  ...
  var friendFactory = function(M) {
    ...
    var Friend = (function(_M$Base) {
      ...
      function Friend(props) {
        ...
        return possibleConstructorReturn(
          this,
          (Friend.__proto__ || Object.getPrototypeOf(Friend))
            .call(this, Friend, props)
        )
      }
  ...
  var cityFactory = function(M, Region, countryFactory) {
    ...
    var City = (function(_M$Base) {
      ...
      function City(props) {
        ...
        return possibleConstructorReturn(
          this,
          (City.__proto__ || Object.getPrototypeOf(City))
            .call(this, City, props)
        )
      }
  ...
  var regionFactory = function(M) {
    ...
    var Region = (function(_M$Base) {
      ...
      function Region(props) {
        ...
        return possibleConstructorReturn(
          this,
          (Region.__proto__ || Object.getPrototypeOf(Region))
            .call(this, Region, props)
        )
      }
      createClass(
        Region,
  ...
  var localDateFactory = function(_ref) {
    ...
    var _M$ajvMetadata = M.ajvMetadata(
    ...
    var reviver = function reviver(k, v) {
      return new (Function.prototype.bind.apply(
        LocalDate,
        [null].concat(toConsumableArray(v.split('-').map(Number)))
      ))()
    }
    var LocalDate = (function(_M$Base) {
      ...
      function LocalDate(year, month, day) {
        ...
        var _this = possibleConstructorReturn(
          this,
          (LocalDate.__proto__ || Object.getPrototypeOf(LocalDate))
            .call(this, LocalDate, {
              year: year,
              month: month,
              day: day
        ...
        [
          {
            key: 'metadata',
            value: function metadata() {
              var baseMetadata = Object.assign({}, base(LocalDate), {
                reviver: reviver
  ...
  var fixerIoResultFactory = function(_ref, _ref2) {
    ...
    var FixerIoResult = (function(_M$Base) {
      ...
      function FixerIoResult(fields) {
        classCallCheck(this, FixerIoResult) // ensure base is included in the rates
        ...
        var _this = possibleConstructorReturn(
          this,
          (FixerIoResult.__proto__ || Object.getPrototypeOf(FixerIoResult))
            .call(this, FixerIoResult, enhancedFields)
        )
        Object.freeze(_this)
        return _this
      }
  ...
  var fixerIoFactory = function() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined
      ...
      validationEnabled = _ref$validationEnable === undefined
        ? true
        : _ref$validationEnable
    var options = {
      M: M,
      Ajv: Ajv,
  ...
  var fixerIoSpec = function(should, M, _ref, _ref2) {
    ...
    return function() {
      var _M$metadata = M.metadata(), _ = _M$metadata._
      var _fixerIoFactory = fixerIoFactory({
        M: M,
        Ajv: Ajv
      }),
  ...
  var ajvMetadata = function(should, M, fixtures, _ref) {
    ...
    return function() {
      ...
      describe('Animal example', function() {
        ...
        var Animal2 = (function(_M$Base2) {
          ...
          function Animal2(props) {
            ...
            return possibleConstructorReturn(
              this,
              (Animal2.__proto__ || Object.getPrototypeOf(Animal2))
                .call(this, Animal, props)
            )
          }
      ...
      describe('deeply nested error examples', function() {
        ...
        it('map', function() {
          should(function() {
            return M.genericsFromJS(
              M.Map,
              [ajvString(), ajvMap({}, ajvString(), ajvNumber({minimum: 5}))],
              [['A', [['A', 6], ['B', 7], ['C', 4]]]]
            )
          })
            ...
            return M.genericsFromJS(
              ...
              [
                ...
                ajvEnumMap(
                  {},
                  ajv_(SideEnum),
                  ajvEnumMap({}, ajv_(SideEnum), ajvNumber({minimum: 5}))
                )
              ],
              {
                A: {
      ...
      describe('number: wrapped json-compatible', function() {
        ...
        it('supports missing schema', function() {
          should(
            JSON.parse('1', ajvNumber({}, {wrap: true}).reviver).inner()
          ).be.exactly(1)
        })
        it('supports valid numbers with schema', function() {
          should(
            JSON.parse(
              '4',
              ajvNumber({minimum: 3}, {wrap: true}).reviver
            ).inner()
          ).be.exactly(4)
        })
        it('rejects invalid numbers', function() {
      ...
      describe('date', function() {
        ...
        it('supports valid dates', function() {
          should(
            JSON.parse('"1988-04-16T00:00:00.000Z"', ajvDate().reviver)
              .inner()
              .getFullYear()
          ).be.exactly(1988)
        })
      ...
      describe('enumMap', function() {
        var Side = (function(_M$Enum) {
          ...
          function Side() {
            ...
            return possibleConstructorReturn(
              this,
              (Side.__proto__ || Object.getPrototypeOf(Side))
                .apply(this, arguments)
            )
          }
          return Side
        ...
        it('supports empty schema', function() {
          should(
            JSON.parse(
              '{"B": 100}',
              ajvEnumMap({}, ajv_(SideEnum), ajvNumber()).reviver
            ).get(SideEnum.B())
          ).be.exactly(100)
        })
        it('supports valid enumMaps with schema', function() {
          should(
            JSON.parse(
              '{"B": 100}',
              ajvEnumMap({minProperties: 1}, ajv_(SideEnum), ajvNumber())
                .reviver
            ).get(SideEnum.B())
          ).be.exactly(100)
        })
        it('rejects invalid enumMaps', function() {
          should(function() {
            return JSON.parse(
              '{"A": 100}',
              ajvEnumMap({minProperties: 2}, ajv_(SideEnum), ajvNumber())
                .reviver
            )
          ...
          should(function() {
            return JSON.parse(
              '{"A": 100, "B": 200, "C": 300}',
              ajvEnumMap({maxProperties: 3}, ajv_(SideEnum), ajvNumber())
                .reviver
            )
          })
      ...
      describe('list', function() {
        it('list', function() {
          M.getSchema(
            ajvList({minItems: 2}, ajvNumber({minimum: 5}))
          ).should.deepEqual({
            type: 'array',
            minItems: 2,
            items: {
        ...
        it('rejects invalid lists', function() {
          should(function() {
            return JSON.parse(
              '[2,5,7,1]',
              ajvList({maxItems: 3}, ajvNumber()).reviver
            )
      ...
      describe('map', function() {
        ...
        it('supports empty schema', function() {
          JSON.parse(
            '[[2, "dos"],[5, "cinco"]]',
            ajvMap({}, ajvNumber(), ajvString()).reviver
          )
        ...
        it('supports valid maps with schema', function() {
          JSON.parse(
            '[[2, "dos"],[5, "cinco"]]',
            ajvMap({minItems: 2}, ajvNumber(), ajvString()).reviver
          )
            .equals(M.Map.of(2, 'dos', 5, 'cinco'))
            .should.be.exactly(true)
        })
        it('rejects invalid maps', function() {
          ...
          should(function() {
            return JSON.parse(
              '[[1, "uno"], [2, "dos"], [3, "tres"]]',
              ajvMap({minItems: 4}, ajvNumber(), ajvString()).reviver
            )
      ...
      describe('stringMap', function() {
        ...
        it('supports empty schema', function() {
          should(
            JSON.parse('{"uno": 1}', ajvStringMap({}, ajvNumber()).reviver).get(
              'uno'
            )
          ).be.exactly(1)
        })
        it('supports valid stringMaps with schema', function() {
          should(
            JSON.parse(
              '{"uno": 1}',
              ajvStringMap({minProperties: 1}, ajvNumber()).reviver
            ).get('uno')
          ).be.exactly(1)
        })
        it('rejects invalid stringMaps', function() {
          should(function() {
            return JSON.parse(
              '{"uno": 1}',
              ajvStringMap({minProperties: 2}, ajvNumber()).reviver
            )
          }).throw(/should NOT have less than 2 properties/)
        })
      })
      describe('set', function() {
        ...
        it('rejects invalid sets', function() {
          should(function() {
            return JSON.parse(
              '[2,5,7,1]',
              ajvSet({maxItems: 3}, ajvNumber()).reviver
            )
          }).throw(/should NOT have more than 3 items/)
        })
        ...
        it('supports duplicates when explicitly told', function() {
          JSON.parse(
            '[2,5,5]',
            ajvSet({uniqueItems: false}, ajvNumber()).reviver
          )
            .equals(M.Set.of(2, 5))
            .should.be.exactly(true)
        })
        ...
        it('should validate the default value', function() {
          var CountryCode = (function(_M$Base4) {
            ...
            function CountryCode(props) {
              ...
              return possibleConstructorReturn(
                this,
                (CountryCode.__proto__ || Object.getPrototypeOf(CountryCode))
                  .call(this, CountryCode, props)
              )
            }
        ...
        it('should work for nested metadata', function() {
          ...
          var MagicString = (function(_M$Base7) {
            ...
            function MagicString(props) {
              ...
              return possibleConstructorReturn(
                this,
                (MagicString.__proto__ || Object.getPrototypeOf(MagicString))
                  .call(this, MagicString, props)
              )
            }
      ...
      describe('anyOf', function() {
        var ScoreType = (function(_M$Enum2) {
          ...
          function ScoreType() {
            ...
            return possibleConstructorReturn(
              this,
              (ScoreType.__proto__ || Object.getPrototypeOf(ScoreType))
                .apply(this, arguments)
            )
          }
          return ScoreType
        })(M.Enum)
        var ScoreTypeEnum = M.Enum.fromArray(
          ['Numeric', 'Alphabetic'],
          ScoreType,
          'ScoreType'
        )
        var Score = (function(_M$Base8) {
          ...
          function Score(props) {
            ...
            return possibleConstructorReturn(
              this,
              (Score.__proto__ || Object.getPrototypeOf(Score))
                .call(this, Score, props)
            )
          }
        ...
        it('self reference', function() {
          var Chain = (function(_M$createAjvModel) {
            ...
            function Chain(props) {
              ...
              return possibleConstructorReturn(
                this,
                (Chain.__proto__ || Object.getPrototypeOf(Chain))
                  .call(this, Chain, props)
              )
            }
            return Chain
          })(
        ...
        it('indirect reference', function() {
          ...
          var Parent = (function(_M$Base9) {
            ...
            function Parent(props) {
              ...
              return possibleConstructorReturn(
                this,
                (Parent.__proto__ || Object.getPrototypeOf(Parent))
                  .call(this, Parent, props)
              )
            }
  ...
  var baseMetadataExample = function(should, M, fixtures, _ref) {
    ...
    return function() {
      ...
      it('should return the base metadata for standard models', function() {
        ...
        should(function() {
          return M.fromJS(Range, {
            min: 4,
            max: 3.5
          })
        }).throw('"min" must be less than or equal to "max"')
        var validRange = new Range({
          min: 0,
          max: 5
        })
  ...
  } /* eslint-env mocha */ /* global requestIdleCallback, setImmediate, setTimeout */
      ...
      it('should revive data asynchronously', function() {
        ...
        var Library = (function(_M$createModel2) {
          ...
          function Library(props) {
            ...
            return possibleConstructorReturn(
              this,
              (Library.__proto__ || Object.getPrototypeOf(Library))
                .call(this, Library, props)
            )
          }
          return Library
        })(
  ...
  /* eslint-env mocha */ var binaryTree = function(should, M, fixtures, _ref) {
    var Ajv = _ref.Ajv
    return function() {
      var binaryTreeFactory = function binaryTreeFactory(valueMetadata, ajv) {
        var _M$ajvMetadata = M.ajvMetadata(ajv),
          _ = _M$ajvMetadata._,
          base = _M$ajvMetadata.base,
          ajvMeta = _M$ajvMetadata.ajvMeta,
          ajvBase = _M$ajvMetadata.ajvBase
        var treeReviver = function treeReviver(k, obj) {
          var path = arguments.length > 2 && arguments[2] !== undefined
            ? arguments[2]
            : []
          if (k !== '') {
          ...
          var subType = obj === null ? Empty : Node
        ...
        var Tree = (function(_M$Base) {
          ...
          function Tree() {
            ...
            return possibleConstructorReturn(
              this,
              (Tree.__proto__ || Object.getPrototypeOf(Tree))
                .apply(this, arguments)
            )
          }
          createClass(Tree, null, [
            ...
            },
            {
              key: 'metadata',
              value: function metadata() {
                var baseMetadata = Object.assign(
                  {},
                  {
                    reviver: treeReviver
                  }
                ...
                return ajvMeta(baseMetadata, {}, {}, function() {
                  return {
                    anyOf: [Empty, Node].map(function(x) {
                      return M.getSchema(_(x), false)
                    })
                  }
                })
              }
        ...
        var Empty = (function(_Tree) {
          ...
          function Empty() {
            ...
            var _this2 = possibleConstructorReturn(
              this,
              (Empty.__proto__ || Object.getPrototypeOf(Empty))
                .call(this, Empty)
            )
            if (!empty) {
              empty = _this2
        ...
        var balanceArray = function balanceArray(arr) {
          ...
          return [v].concat(
            toConsumableArray(balanceArray(leftArr)),
            toConsumableArray(balanceArray(rightArr))
          )
        }
        var Node = (function(_Tree2) {
          ...
          function Node() {
            ...
            return possibleConstructorReturn(
              this,
              (Node.__proto__ || Object.getPrototypeOf(Node)).call(this, Node, {
                value: value,
                left: left,
                right: right
              })
              ...
              },
              {
                ...
                value: function toArray$$1() {
                  return [this.value()].concat(
                    toConsumableArray(this.left().toArray()),
                    toConsumableArray(this.right().toArray())
                  )
                }
              },
              {
      ...
      var _M$ajvMetadata2 = M.ajvMetadata(ajv),
        _ = _M$ajvMetadata2._,
        ajvNumber = _M$ajvMetadata2.ajvNumber,
        ajvString = _M$ajvMetadata2.ajvString
      var numberTree = binaryTreeFactory(ajvNumber(), ajv)
      var stringTree = binaryTreeFactory(ajvString(), ajv)
  ...
  /* eslint-env mocha */ var hasProxies = (function() {
    try {
  ...
  var modelicoSpec = function(_ref) {
    var Should = _ref.Should, M = _ref.Modelico, extensions = _ref.extensions
    return function() {
      var U = buildUtils()
      ...
      describe(
        'base metadata example',
        baseMetadataExample.apply(undefined, deps)
      )
      describe('Readme simple features', featuresSimple.apply(undefined, deps))
      describe(
        'Readme advanced features',
        featuresAdvanced.apply(undefined, deps)
      )
      describe(
        'Readme advanced features ES5',
        featuresAdvancedES5.apply(undefined, deps)
      )
      describe(
        'Deep nesting features',
        featuresDeepNesting.apply(undefined, deps)
      )
      describe(
        'Reviving polymrphic JSON',
        featuresPolymorphic.apply(undefined, deps)
      )
      describe(
        'Immutable examples',
        ImmutableExamples.apply(undefined, [U].concat(deps))
      )
      describe('Api Example: Fixer IO', fixerIoSpec.apply(undefined, deps))
      describe('Async reviving', asyncReviving.apply(undefined, deps))
      describe('Binary tree', binaryTree.apply(undefined, deps))
      U.skipIfNoProxies(describe)(
        'Immutable examples (proxied)',
        ImmutableProxied.apply(undefined, [U].concat(deps))
      )
