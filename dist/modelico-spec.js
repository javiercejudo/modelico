;(function(global, factory) {
    ...
    return function() {
      ...
      describe('M.new', function() {
        it('helps create Modelico instances in composition with map and others', function() {
          ...
          should(
            [10, 20, Infinity].map(M.new(M.Number)).reduce(function(eq, x, i) {
  ...
  var ModelicoEnum = function(should, M, _ref) {
    ...
    return function() {
      ...
      describe('equals', function() {
        it('should identify equal instances', function() {
          Object.is(PartOfDay.MORNING(), PartOfDay.MORNING()).should.be.exactly(
            true
          )
      ...
      var Point = (function(_M$Base) {
        ...
        function Point(props) {
          ...
          var _this = possibleConstructorReturn(
            this,
            (Point.__proto__ || Object.getPrototypeOf(Point))
              .call(this, Point, props)
          )
  ...
  var currencyFactory = function(_ref) {
    ...
    var Currency = (function(_M$Enum) {
      ...
      function Currency() {
        ...
        return possibleConstructorReturn(
          this,
          (Currency.__proto__ || Object.getPrototypeOf(Currency))
            .apply(this, arguments)
        )
      }
  ...
  var localDateFactory = function(_ref) {
    ...
    var reviver = function reviver(k, v) {
      return LocalDate.of.apply(
        LocalDate,
        toConsumableArray(v.split('-').map(Number))
      )
    }
  ...
  var fixerIoFactory = function() {
    var _ref =
      ...
      validationEnabled =
        _ref$validationEnable === undefined ? true : _ref$validationEnable
          ...
          var validate = function validate(schema, value, path) {
            ...
            var formatError = function formatError() {
              return [
                ...
                .concat(
                  toConsumableArray(
                    implValidate.errors.map(function(err) {
                      return '' + err.message
                    })
                  )
                )
  ...
  var ajvMetadata = function(U, should, M, fixtures, _ref) {
    ...
    return function() {
          ...
          createClass(Animal, null, [
            {
              ...
              value: function innerTypes() {
                return Object.freeze({
                  ...
                  dimensions: maybe(
                    list(number({exclusiveMinimum: 0}), {
                      minItems: 3,
                      maxItems: 3
                    })
                  )
      ...
      describe('number: wrapped non-json-compatible', function() {
        ...
        it('supports valid numbers with schema', function() {
          should(
            JSON.parse(
              '"Infinity"',
              wrappedNumber({minimum: 3}).reviver
            ).inner()
          ).be.exactly(Infinity)
        })
      ...
      describe('list', function() {
        ...
        it('rejects invalid lists', function() {
          should(function() {
            return JSON.parse(
              '[2,5,7,1]',
              list(number(), {maxItems: 3}).reviver
            )
      ...
      describe('set', function() {
        ...
        it('supports empty schema', function() {
          JSON.parse('[2,5]', set$$1(number()).reviver)
            .equals(M.Set.of(2, 5))
            .should.be.exactly(true)
        })

        it('supports valid sets with schema', function() {
          JSON.parse('[2,5]', set$$1(number(), {maxItems: 3}).reviver)
            .equals(M.Set.of(2, 5))
            .should.be.exactly(true)
        })
        ...
        it('rejects invalid sets', function() {
          should(function() {
            return JSON.parse(
              '[2,5,7,1]',
              set$$1(number(), {maxItems: 3}).reviver
            )
          }).throw(/should NOT have more than 3 items/)
        })
        ...
        it('supports duplicates when explicitly told', function() {
          JSON.parse('[2,5,5]', set$$1(number(), {uniqueItems: false}).reviver)
            .equals(M.Set.of(2, 5))
            .should.be.exactly(true)
        })
      })
      ...
      describe('withValidation', function() {
        ...
        it('should compose well', function() {
          var noNumbers = M.withValidation(
            function(v) {
              return /^[^0-9]*$/.test(v)
            },
            function(v, path) {
          ...
          var lowercase = M.withValidation(
            function(v) {
              return v.toLowerCase() === v
            },
            function(v, path) {
          ...
          function Range() {
            ...
            return possibleConstructorReturn(
              ...
              (Range.__proto__ || Object.getPrototypeOf(Range))
                .call(this, Range, {min: min, max: max})
            )
          }
  ...
  var withDefaultMetadata = function(should, M, fixtures, _ref) {
    ...
    return function() {
      ...
      it('should have a proper reviver', function() {
        ...
        JSON.parse('null', withDefault(number(), 1).reviver).should.be.exactly(
          1
        )
      ...
      it('should help create union types', function() {
        ...
        var Anonymous = (function(_User) {
          ...
          function Anonymous() {
            ...
            return possibleConstructorReturn(
              this,
              (Anonymous.__proto__ || Object.getPrototypeOf(Anonymous))
                .call(this, Anonymous)
            )
          }
        ...
        var Named = (function(_User2) {
          ...
          function Named(props) {
            ...
            return possibleConstructorReturn(
              this,
              (Named.__proto__ || Object.getPrototypeOf(Named))
                .call(this, Named, props)
            )
          }
      ...
      it('should work with any types (no common parent class) (2)', function() {
        ...
        var Square = (function(_M$Base5) {
          ...
          function Square(props) {
            ...
            return possibleConstructorReturn(
              this,
              (Square.__proto__ || Object.getPrototypeOf(Square))
                .call(this, Square, props)
            )
          }
      ...
      it('should warn about ambiguous structures and empty matches', function() {
        ...
        var Hexagon = (function(_M$createModel3) {
          ...
          function Hexagon(props) {
            ...
            return possibleConstructorReturn(
              this,
              (Hexagon.__proto__ || Object.getPrototypeOf(Hexagon))
                .call(this, Hexagon, props)
            )
          }
        ...
        var Shape = M.createUnionType(
          [Square, Hexagon].map(function(x) {
            return _(x)
          })
        )
        ...
        Shape.area(mySquare).should.be.exactly(9)
        Shape.area(myHexagon).should.be.exactly(
          3 * Math.sqrt(3) * Math.pow(3, 2) / 2
        )
    ...
    return function() {
      describe('normal metadata', function() {
        ...
        it('map', function() {
          m
            .map(m.date(), m.number())
            .should.be.exactly(m.map(m.date(), m.number()))
        })
  ...
  var binaryTree = function(_ref, should, M, fixtures, _ref2) {
    ...
    return function() {
          ...
          function Node() {
            ...
            return possibleConstructorReturn(
              ...
              (Node.__proto__ || Object.getPrototypeOf(Node))
                .call(this, Node, {value: value, left: left, right: right})
            )
          }
      ...
      it('schema: Tree<Animal>', function() {
        ...
        var _binaryTreeFactory = binaryTreeFactory(_(Animal), {
            cmp: cmp,
            ajv: ajv
          }),
  ...
  var shuffle = function shuffle(arr) {
    for (var l = arr.length - 1; l > 0; l -= 1) {
      var i = Math.floor((l + 1) * Math.random())
  ...
  var modelicoSpec = function(_ref2) {
    ...
    return function() {
      ...
      describe(
        'jsonSchemaMetadata (other than Ajv)',
        jsonSchemaMetadata.apply(undefined, deps)
      )
      ...
      describe(
        ...
        withDefaultMetadata.apply(undefined, deps)
      )
      describe('union metadata', unionMetadata.apply(undefined, deps))
      describe(
        'Metadata as singletons',
        singletonMetadata.apply(undefined, deps)
      )
      ...
      describe(
        ...
        featuresCustomSerialisation.apply(undefined, deps)
      )
      describe(
        'Immutable examples',
