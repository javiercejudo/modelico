...
var ModelicoMap = (function (U, should, M, _ref) {
  ...
  return function () {
    ...
    describe('stringifying', function () {
      it('should stringify the map correctly (as array)', function () {
      ...
      it('should stringify the map correctly (as object)', function () {
        var map = new Map([['a', M.Date.of(new Date('1988-04-16T00:00:00.000Z'))], ['b', M.Date.of(new Date('2012-12-25T00:00:00.000Z'))]]);

        var modelicoMap = M.Map.fromMapWithOptions({ asArray: false }, map);
    ...
    describe('parsing', function () {
      it('should parse the map correctly (as array)', function () {
      ...
      it('should parse the map correctly (as object)', function () {
        var myMap = JSON.parse('{"\\"a\\"":"1988-04-16T00:00:00.000Z","\\"b\\"":"2012-12-25T00:00:00.000Z"}', map(string(), date()).reviver);

        myMap.inner().get('a').inner().getFullYear().should.be.exactly(1988);
        myMap.inner().get('b').inner().getMonth().should.be.exactly(11);

        var empty = JSON.parse('{}', map(string(), date()).reviver);
      ...
      it('should be parsed correctly when used within another class', function () {
        ...
        author.lifeEvents().inner().get('wedding').inner().getFullYear().should.be.exactly(2013);
      });
  ...
  return function () {
    ...
    var binaryTreeFactory = function binaryTreeFactory(valueMetadata) {
      ...
      var balanceArray = function balanceArray(arr) {
        ...
        return [v].concat(toConsumableArray(balanceArray(leftArr)), toConsumableArray(balanceArray(rightArr)));
      };
